...
class TaskControllerTest {
    ...
    private final static String OBJECT_ID = "63e947ecc8e965e7a82bda69";


    @Test
    public void saveTask_expectStatus_isCreated() throws Exception {
        TaskDto request = new TaskDto("someTitle", null, null, null, true);
        TaskResponse response = new TaskResponse("someTitle", true, null, null, null);
    ...
    void updateTask_expectStatus_ok() throws Exception {
        TaskDto request = new TaskDto("someTitle", null, null, null, true);
        TaskResponse response = new TaskResponse("updateTitle", true, null, null, null);
        response.add(linkTo(methodOn(TaskController.class)
                .getTaskByID(OBJECT_ID)).withSelfRel());
    ...
    void getTasks_expectStatus_ok() throws Exception {
        TaskResponse response = new TaskResponse("someTitle", true, null, null, null);
        TaskResponse response1 = new TaskResponse("someTitle1", true, null, null, null);
        TaskResponse response2 = new TaskResponse("someTitle2", true, null, null, null);
        List<TaskResponse> list = Arrays.asList(response, response1, response2);
